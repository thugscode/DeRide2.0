...
######################################################
# Set the chaincode source path based on the language#
######################################################
...
# #### Update the path to your test-network.####

pushd /home/shailesh/Hyperledger/fabric/fabric-samples/test-network
./network.sh down
./network.sh up createChannel -ca -s couchdb
./network.sh deployCC -ccn rideSharing -ccv 1 -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
